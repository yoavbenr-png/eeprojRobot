...
MAX_TURN_CMD = 7            # Maximum speed for standard turning
...
VISUAL_SIZE_APPROACH_STEPS  = 1     #Number of steps to take forward if the object is visible but too small.
